...
import SendMessage from './care-partner/SendMessage';
...
export default function CarePartnerDashboard() {
  ...
  const currentView = currentPath.split('/')[2] || 'dashboard';
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden md:flex items-center space-x-3 pl-4 border-l border-gray-200">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Supporting Margaret</p>
                </div>
              </div>
            </div>
          </div>
